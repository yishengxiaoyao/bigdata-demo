...
public class JSONExecSource extends AbstractSource implements EventDrivenSource, Configurable {

  private static final Logger logger = LoggerFactory.getLogger(JSONExecSource.class);
                  ...
                  if(line.contains("INFO")==true || line.contains("WARN")==true || line.contains("ERROR")==true || line.contains("DEBUG")==true || line.contains("FATAL")){
                	  ...
                	  if(tmpevent.length()>0){
                		  ...
                		  if(jsonvalidator.validate(tmpevent)){
                			  eventList.add(EventBuilder.withBody(tmpevent.getBytes(charset.name())));
                		  }
                		  tmpevent=""; 
                		  tmpremainlines="";
                	  }
