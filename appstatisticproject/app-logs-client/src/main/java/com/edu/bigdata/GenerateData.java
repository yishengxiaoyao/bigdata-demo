...
public class GenerateData {
    ...
    // 1 准备基类log的属性值
    // 1.1 功能属性值
    private static Long[] createdAtMs = initCreatedAtMs();         // 日志创建时间
    ...
    private static String[] appChannels = {"youmeng1", "youmeng2"}; // 渠道，安装时就在清单中指定了，如 appStore 等
    ...
    private static String[] errorBriefs = {"at cn.lift.dfdf.web.AbstractBaseController.validInbound(AbstractBaseController.java:72)", "at cn.lift" +
            ".appIn.control.CommandUtil.getInfo(CommandUtil.java:67)"}; // 错误摘要
